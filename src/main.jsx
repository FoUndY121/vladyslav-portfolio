...
const translations = {
		...
		experience: [
			{
				...
				company: 'immovativ GmbH Germany',
				date: 'Feb 2024 – Jan 2026',
				bullets: [
					'Developed production websites for clients including e-commerce stores, online course platforms, landing pages and business websites in a 15-person development team.',
					'Built reusable UI/UX components, complete responsive pages and small-to-medium websites using React, TypeScript, Next.js and Redux Toolkit.',
					'Worked across the development lifecycle: implementing designs, integrating REST APIs, debugging production issues, refactoring code and improving performance and maintainability.',
					'Contributed to backend development on larger projects with NestJS and Express.js, implementing APIs, business logic and database integrations.',
					'Used Git for team workflows, Keitaro for traffic and user-flow analytics and FastPanel for deployment, hosting and production management.',
				],
			},
			{
				role: 'Freelance E-Commerce / Full-Stack Developer',
				company: 'Client Projects — Germany / Remote • kurb-global.com',
				date: '2025 – Present',
				bullets: [
					'Led ongoing development for KURB Global, a live WooCommerce e-commerce store, translating business requirements into production-ready technical solutions.',
					'Redesigned and extensively customised the storefront using WordPress, WooCommerce, Elementor and 1,500+ lines of custom CSS / theme and catalogue logic.',
					'Implemented custom product and promotional behaviour including catalogue sections, responsive layouts, product pairing, size handling, bundle discounts and pricing presentation.',
					'Worked on checkout and payment integrations including Mollie and Apple Pay, and configured customer automation flows with Brevo for welcome, abandoned-cart and post-purchase communication.',
					'Troubleshot live-site issues, supported hosting migration and recovery, and maintained production functionality while iterating directly with the client.',
				],
			},
		],
		projectsSection: {
	...
	de: {
		...
		experience: [
			{
				role: 'Frontend- / Full-Stack-Entwickler',
				company: 'immovativ GmbH Deutschland',
				date: 'Feb. 2024 – Jan. 2026',
				bullets: [
					'Entwicklung produktiver Websites für Kunden, darunter Online-Shops, Online-Kursplattformen, Landingpages und Unternehmenswebsites in einem 15-köpfigen Entwicklungsteam.',
					'Entwicklung wiederverwendbarer UI/UX-Komponenten, vollständiger responsiver Seiten sowie kleiner bis mittelgroßer Websites mit React, TypeScript, Next.js und Redux Toolkit.',
					'Mitarbeit über den gesamten Entwicklungszyklus hinweg: Umsetzung von Designs, Integration von REST-APIs, Fehlerbehebung im Produktivbetrieb, Refactoring sowie Verbesserung von Performance und Wartbarkeit.',
					'Mitarbeit an der Backend-Entwicklung größerer Projekte mit NestJS und Express.js, einschließlich APIs, Business-Logik und Datenbankintegrationen.',
					'Nutzung von Git für Team-Workflows, Keitaro für Traffic- und User-Flow-Analysen sowie FastPanel für Deployment, Hosting und Produktionsverwaltung.',
				],
			},
			{
				role: 'Freelance E-Commerce / Full-Stack-Entwickler',
				company: 'Kundenprojekte — Deutschland / Remote • kurb-global.com',
				date: '2025 – heute',
				bullets: [
					'Fortlaufende Entwicklung von KURB Global, einem produktiven WooCommerce-Onlineshop, und Umsetzung geschäftlicher Anforderungen in produktionsreife technische Lösungen.',
					'Umfassende Anpassung des Storefronts mit WordPress, WooCommerce, Elementor und mehr als 1.500 Zeilen benutzerdefiniertem CSS sowie Theme- und Kataloglogik.',
					'Implementierung individueller Produkt- und Aktionslogik, darunter Katalogbereiche, responsive Layouts, Produkt-Pairing, Größenlogik, Bundle-Rabatte und Preisdarstellung.',
					'Arbeit an Checkout- und Zahlungsintegrationen mit Mollie und Apple Pay sowie Einrichtung von Brevo-Automationen für Welcome-, Abandoned-Cart- und Post-Purchase-Kommunikation.',
					'Fehleranalyse auf der Live-Seite, Unterstützung bei Hosting-Migration und Wiederherstellung sowie laufende technische Betreuung in direkter Abstimmung mit dem Kunden.',
				],
			},
		],
		projectsSection: {
