    ...
    projects: [
      {
        ...
        description: 'A full-stack platform for publishing and exploring travel stories, with authentication, image uploads, profiles, and a documented REST API.',
      ...
      },
      {
        ...
        description: 'Production e-commerce development with custom bundle logic, email automation, checkout improvements, responsive UI, and ongoing technical support.',
      ...
      },
      {
        ...
        description: 'A responsive habit-management interface focused on clear state handling, reusable React components, and a fast user experience.',
      ...
      },
      {
        ...
        description: 'A modern vehicle marketplace with filtering, favourites, detailed listings, responsive layouts, and API-driven content.',
    ...
    skillGroups: [
      {
        icon: Code2,
        title: 'Frontend',
        skills: ['JavaScript', 'TypeScript', 'React', 'Next.js', 'Redux Toolkit', 'HTML5', 'CSS3', 'Tailwind CSS'],
      },
      {
        icon: Server,
        title: 'Backend',
        skills: ['Node.js', 'Express.js', 'NestJS', 'REST APIs', 'JWT', 'Swagger / OpenAPI'],
      },
      {
        icon: Database,
        title: 'Data & Tools',
        skills: ['PostgreSQL', 'MongoDB', 'Prisma', 'Mongoose', 'Git', 'Docker', 'Postman', 'Vite'],
      },
    ],
    education: {
      aria: 'Education',
      ...
      university: 'National Technical University “Kharkiv Polytechnic Institute” · 2021—2025',
    ...
    projects: [
      {
        ...
        description: 'Eine Full-Stack-Plattform zum Veröffentlichen und Entdecken von Reiseberichten mit Authentifizierung, Bilduploads, Profilen und dokumentierter REST-API.',
        stack: ['React 19', 'Node.js', 'MongoDB', 'JWT', 'Cloudinary'],
        live: 'https://podorozhnyky.vercel.app',
        accent: 'travel',
        mark: 'P',
      },
      {
        ...
        description: 'Weiterentwicklung eines produktiven Online-Shops mit individueller Bundle-Logik, E-Mail-Automatisierung, Checkout-Optimierung, responsiver Oberfläche und laufendem technischem Support.',
        stack: ['WordPress', 'WooCommerce', 'Brevo', 'Mollie', 'CSS'],
        live: 'https://kurb-global.com',
        accent: 'commerce',
        mark: 'K',
      },
      {
        ...
        description: 'Eine responsive Anwendung zur Verwaltung von Gewohnheiten mit klarer Zustandsverwaltung, wiederverwendbaren React-Komponenten und schneller Benutzeroberfläche.',
        stack: ['React', 'Redux Toolkit', 'JavaScript', 'Vite'],
        live: 'https://habit-jcsz.vercel.app',
        accent: 'habit',
        mark: 'H',
      },
      {
        ...
        description: 'Ein moderner Fahrzeug-Marktplatz mit Filtern, Favoriten, Detailansichten, responsiven Layouts und API-basierten Inhalten.',
        stack: ['React', 'Redux Toolkit', 'REST API', 'CSS'],
        live: 'https://rental-car-khaki.vercel.app',
        accent: 'car',
        mark: 'R',
      ...
      <main className="language-content" key={language}>
        <section className="hero section" id="top">
          ...
          <div className="hero-copy reveal is-visible" data-reveal="left">
            ...
            <div className="hero-actions">
              ...
              <a className="button secondary" href="mailto:foundybash@gmail.com">
                <Mail size={18} /> {t.hero.contactMe}
              </a>
            </div>
            <div className="hero-links" aria-label={t.hero.socialAria}>
              <a href="https://github.com/FoUndY121" target="_blank" rel="noreferrer">
                <GitHubIcon size={18} /> GitHub
              </a>
              <a href="https://linkedin.com/in/vladyslav-mashyrov" target="_blank" rel="noreferrer">
                <LinkedInIcon size={18} /> LinkedIn
              </a>
              <span><MapPin size={18} /> {t.hero.location}</span>
            </div>
          </div>

          <div className="hero-visual reveal is-visible delay-1" data-reveal="right" aria-label={t.hero.profileAria}>
            ...
            >
              ...
              <img
                src={photoFailed ? '/profile-placeholder.svg' : '/profile-photo.png'}
        ...
        <section className="section" id="experience">
          ...
          <div className="timeline reveal is-visible">
            {t.experience.map((item, index) => (
              ...
              >
                <div className="timeline-marker"><BriefcaseBusiness size={20} /></div>
                <div className="timeline-content">
                  ...
                  <ul>
                    {item.bullets.map((bullet) => (
                      <li key={bullet}><CheckCircle2 size={17} /> <span>{bullet}</span></li>
                    ))}
                  </ul>
                </div>
              </article>
        ...
        <section className="section" id="projects">
          <div className="section-heading projects-heading reveal is-visible">
            ...
            <a className="text-link" href="https://github.com/FoUndY121" target="_blank" rel="noreferrer">
            ...
            {t.projects.map((project, index) => (
              ...
              >
                ...
                <div className={`project-preview ${project.accent}`}>
                  <div className="preview-window"><span /><span /><span /></div>
                  <div className="preview-mark">{project.mark}</div>
        ...
        <section className="section contact-section" id="contact">
          <div className="contact-card reveal is-visible">
            <div className="contact-orbit orbit-contact-one" aria-hidden="true" />
            <div className="contact-orbit orbit-contact-two" aria-hidden="true" />
            ...
            <div className="contact-actions">
              ...
              <a className="button secondary" href="https://linkedin.com/in/vladyslav-mashyrov" target="_blank" rel="noreferrer">
                <LinkedInIcon size={18} /> LinkedIn
              </a>
            </div>
          </div>
